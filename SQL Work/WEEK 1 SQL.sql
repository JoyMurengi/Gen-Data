-- CREATE DATABASE IF NOT EXISTS somalia_data;
USE somalia_data;
...
-- FROM 
--     beneficiary_partner_data AS b
-- JOIN 
--     jurisdiction_hierarchy AS v 
--     ON b.village = v.name AND v.level = 'Village'
-- JOIN 
--     jurisdiction_hierarchy AS d 
--     ON v.parent_name = d.name AND d.level = 'District'
-- JOIN 
--     jurisdiction_hierarchy AS r 
--     ON d.parent_name = r.name AND r.level = 'Region'
-- GROUP BY 
--     d.name, r.name;
