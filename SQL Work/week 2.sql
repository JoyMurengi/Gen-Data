...
-- SELECT * FROM financial_details WHERE stud_name IS NULL OR stud_name = '';
...
--   AND p.stud_name IS NOT NULL;

-- ALTER TABLE financial_details ADD COLUMN fee_cleared BOOLEAN;
...
--     SUM(CASE WHEN fee_paid < sem_fee THEN sem_fee - fee_paid ELSE 0 END) AS total_deficit
